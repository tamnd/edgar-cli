...
Most of these come down to network reality or how edgar serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

edgar rate-limits like any public site. edgar already paces
...
Where a surface is gated, edgar reads a cookie or token you supply
...
`edgar`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what edgar actually did
